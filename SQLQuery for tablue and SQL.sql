...
Select SUM(new_Cases) as total_Cases, SUM(cast(new_deaths as int)) as total_deaths,  SUM(cast(new_deaths as int))/SUM(new_Cases)*100 as  DeathPercentage
 ...
 --just a double check based off the data provied
 --number are extemely close so we keep thenm * The second includes "International"location
...
and location not in ('world', ' Asian','International')
Group by location
